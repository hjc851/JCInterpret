...
object BPlagGraphExtractor_AllMethods {

    val traceRoot = Paths.get("/home/haydencheers/Documents/externally_sourced_experiments/bplag/traces-allmethods")
    ...
    val X_MX_HEAP = "-Xmx10G"
    val D_STREAM_PARALLELISM = "-Djava.util.concurrent.ForkJoinPool.common.parallelism=6"
